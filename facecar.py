"""
    ...
    Using medium model:
        python3 facecar.py --img 640 --weights runs/train/medium/weights/best.pt --source 0 --conf 0.87 --hide-conf --line-thickness 1 --max-det 6 --facecar
    Using small model:
...
def run(
        ...
        data=ROOT / 'data/faceCarData.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/faceCarData.yaml', help='(optional) dataset.yaml path')
